...
class HeaderPage extends Page {
    ...
    get ProfileLink() {
        return $('a[href="/profile"]'); // thêm nút Profile
    }
    ...
    async openNavbar() {
        await this.userMenu.waitForDisplayed({ timeout: 5000 }); //click mở Navbar
        await this.Navbar.click();
    }

    async clickProfileLink() {
        await this.ProfileLink.waitForDisplayed({ timeout: 5000 }); // click mở profile
    ...
    async logout1() {
        await this.userMenu.waitForClickable({ timeout: 15000 });
        await this.userMenu.click();

        await this.logoutLink.waitForClickable({ timeout: 15000 });
        await this.logoutLink.click();
